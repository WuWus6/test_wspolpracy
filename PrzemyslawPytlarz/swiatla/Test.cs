...
namespace TrafficLight
{
    class Program
    {
        ...
        static void RunTests()
        {
            ...
            TestCars(
                new List<Tuple<char, char, string>>()
                {
                    new Tuple<char, char, string>('N', 'E', "EW"),
                    new Tuple<char, char, string>('N', 'W', "EW"),
                    new Tuple<char, char, string>('N', 'S', "EW"),
                    new Tuple<char, char, string>('N', 'E', "EW")
                }, 
            ...
            TestCars(
                ...
                {
                    new Tuple<char, char, string>('N', 'E', "EW"),
                    new Tuple<char, char, string>('E', 'W', "NS"),
            ...
            TestCars(
                new List<Tuple<char, char, string>>()
                {
                    new Tuple<char, char, string>('S', 'E', "NS"),
                    new Tuple<char, char, string>('W', 'E', "EW"),
                    new Tuple<char, char, string>('S', 'N', "NS"),
                    new Tuple<char, char, string>('N', 'E', "EW")
                },
                new Dictionary<char, int>()
                {
            ...
            TestCars(
                new List<Tuple<char, char, string>>()
                {
                    ...
                    new Tuple<char, char, string>('E', 'W', "NS"),
                    new Tuple<char, char, string>('W', 'S', "NS"),
                    new Tuple<char, char, string>('N', 'E', "EW")
                },
                new Dictionary<char, int>()
                {
        ...
        {
            lanes = new Dictionary<char, Queue<Car>>()
            {
                { 'N', new Queue<Car>() },
                { 'S', new Queue<Car>() },
                { 'E', new Queue<Car>() },
            ...
            testInfo += $"\u001b[33mTest: TestCars {testCount++}\n";
